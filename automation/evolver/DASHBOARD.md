...
Last run: 2026-09-14 12:11:22 UTC
...
- `apps/notifications/views.py`: 2 -> 3 (shape -> pulse, score=4.611)
- `apps/reporting/services.py`: 15 -> 14 (anchor -> drift, score=-0.268)
- `apps/orders/selectors.py`: 12 -> 13 (sync -> weave, score=4.653)
